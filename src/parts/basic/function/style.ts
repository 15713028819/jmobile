...
import { $CLASS, $VAR, $PRESET, $MAP } from '@/parts/style';
 ...
 */
const setVar = function(item: string, styles: object): void {
    ...
    let value: string | number = $VAR[variable][index];
 ...
 * @param {object} styles 源styles对象
 */
const setPreset = function(item: string, styles: object): void {
    ...
    for (let key in preset) {
        ...
        // 取其值
        let value: string | number = preset[key];
 ...
 * @param {object} styles 源styles对象
 */
const setDirect = function(item: string, styles: object): void {
    ...
    arr.shift();
    let value: string | number = arr.join('-');
 ...
 * @param {object} styles 源styles对象
 */
const setClass = function(item: string, styles: object): void {
    ...
    const items: string[] = params.split(' ');
 ...
 */
export function _(params: string, extra?: object): object {
